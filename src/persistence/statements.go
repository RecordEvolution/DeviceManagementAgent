...
const QueryUpsertRequestedStateEntry = `INSERT INTO RequestedAppStates(app_name, app_key, stage, container_name, current_state, manually_requested_state, image_name, repository_image_name, requestor_account_key, timestamp)
