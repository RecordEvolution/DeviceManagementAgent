...
manually_requested_state, requestor_account_key, release_key, new_release_key FROM RequestedAppStates`
...
manually_requested_state, requestor_account_key, release_key, new_release_key FROM RequestedAppStates WHERE app_key = ? AND stage = ?`
...
const QueryUpsertRequestedStateEntry = `INSERT INTO RequestedAppStates(app_name, app_key, stage, version, present_version, newest_version, current_state, manually_requested_state, requestor_account_key, release_key, new_release_key, request_update, timestamp)
