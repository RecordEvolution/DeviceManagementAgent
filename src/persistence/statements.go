...
manually_requested_state, requestor_account_key, release_key, new_release_key, request_update, environment_variables, environment_template, ports, docker_compose FROM RequestedAppStates`
...
manually_requested_state, requestor_account_key, release_key, new_release_key, request_update, environment_variables, environment_template, ports, docker_compose FROM RequestedAppStates WHERE app_key = ? AND stage = ?`
