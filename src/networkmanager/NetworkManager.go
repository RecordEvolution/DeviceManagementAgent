...
type NetworkManager interface {
	...
	ActivateConnection(connection Connection, device Device, objectPath dbus.ObjectPath) (ActiveConnection, error)
...
func (nm *networkManager) ActivateConnection(connection Connection, device Device, specificObjectPath dbus.ObjectPath) (ac ActiveConnection, err error) {
